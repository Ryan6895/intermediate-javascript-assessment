...
//  It has a prototype function called eat.  When eat is invoked it uses context to implicitly subract 20 from the precentLeft on the chimichanga.
...
function subway (personName){
  ...
  return function (ingredient){
    ...
    return({orderPerson: name, ingredients: ingredients});
  }
}
